...
<form action="syllabusinfo/add1.do" method="post" class="form-horizontal">
    ...
    <div class="row">
    	<div class="col-sm-8">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="syllabusDate" onClick="WdatePicker()"  class="form-control input-sm" placeholder="请选择工作日期"/>
                </div>
            </div>
        </div>
