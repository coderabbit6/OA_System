...
<form action="syllabusinfo/list1.do" method="post" class="form-inline">
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
    ...
    <a  class="btn btn-success"  href="view/OrganizationWork/syllabusinfo/add_arrange.jsp">添加日程</a>
</div>
<div align="center">
...
<div class="row" style="padding:15px; padding-top:0px; " align="right">
	<display:table class="table table-bordered table-hover table-condensed table-striped" name="list"  pagesize="10" requestURI="syllabusinfo/list1.do">
		...
		<display:column href="syllabusinfo/load1.do" paramId="syllabusId" paramProperty="syllabusId" value="查看"  title="查看"/>
	</display:table>
</div>
