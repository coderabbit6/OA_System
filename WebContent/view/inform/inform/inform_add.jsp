...
<form action="informActive/add.do" method="post" class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" readonly="readonly" name="activeId" value="${market.activeId }" placeholder="自动生成" class="form-control input-sm" />
                </div>
            </div>
        </div>
        <div class="col-sm-5">
