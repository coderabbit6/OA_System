	...
	<div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" readonly="readonly" name="activeName" value="${market.activeName }"  class="form-control input-sm"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">公告内容</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9 col-sm-offset-2">
                	<textarea readonly="readonly" name="activeContent" rows="5" class="form-control">${market.activeContent }</textarea>
                </div>
            </div>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-5">
            <a class="btn btn-warning" href="informActive/list1.do">返回上一级</a>
        </div>
    </div>
</form>
