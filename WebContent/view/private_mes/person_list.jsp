...
<form action="" class="form-horizontal">
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">修改信息</h5>
   	<div class="row">
    	<div class="col-sm-5 col-sm-offset-3">
          	 <a href="system/load1.do?staffId=${staffInfo.staffId }" class="btn btn-success" >修改信息</a>
        </div>
    </div>
</form>
